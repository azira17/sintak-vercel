...
function Footer() {
  return (
    <>
      <footer className="footer sm:footer-horizontal bg-amber-50 text-base-content p-10">
        <aside>
          <div className="flex justify-center items-center gap-2 ">
            <FiCoffee className="text-xl" />{" "}
            <h1 className="text-xl text-amber-900 font-bold">Aroma Sriwijaya</h1>
          </div>
        ...
        <nav>
          <h6 className="footer-title text-amber-900 font-bold">Quick Links</h6>
        ...
        <nav>
          <h6 className="footer-title text-amber-900 font-bold">Coffee Products</h6>
        ...
        <nav className="w-96">
          <h6 className="footer-title text-amber-900 font-bold">Contact Us</h6>
