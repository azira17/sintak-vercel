  ...
  return (
    <>
      <div
        ...
        style={{
          backgroundImage: "url(https://i.pinimg.com/736x/c6/1f/8f/c61f8f42ee089bee27de77f4a64cdbf6.jpg)",
        }}
      >
    ...
    <>
      <div className="hero bg-[#fefbea] min-h-screen ">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <img
            src="https://i.pinimg.com/736x/43/e5/d6/43e5d664fcf8aedc3b6d9a3c24b3a94c.jpg"
          ...
          <div className="flex gap-3">
            <div className="card bg-amber-700 w-96 shadow-sm border-1 border-amber-600">
              <figure  className="bg-white">
                <img
                  src="https://i.pinimg.com/736x/f5/cc/39/f5cc397966b7469e469d0d6afc8b46fe.jpg"
                  alt="Shoes"
            ...
            <div className="card bg-amber-700 w-96 shadow-sm border-1 border-amber-600">
              <figure className="bg-white">
                <img
                  src="https://i.pinimg.com/736x/50/e8/a9/50e8a9f24db594c931e21b146bd62482.jpg"
            ...
            <div className="card bg-amber-700 w-96 shadow-sm border-1 border-amber-600">
              <figure className="bg-white">
                <img
                  src="https://i.pinimg.com/736x/21/5c/fc/215cfc91a60530ee3cce636c6ae685d1.jpg"
                  alt="Shoes"
                  className="rounded-xl"
                />
              </figure>
